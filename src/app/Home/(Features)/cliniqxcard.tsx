...
const CliniQXCard: React.FC<CliniQXCardProps> = ({ identifier = "00001", setIdentifier, className, ...props }) => {
  ...
  return (
    <div className={`flex flex-col items-center space-y-8 ${className}`} {...props}>
      <Card className="w-[90%] max-w-sm h-[200px] sm:w-[320px] sm:h-[200px] md:w-[380px] md:h-[220px] bg-black text-white rounded-2xl shadow-lg relative p-4 flex flex-col justify-center items-center">
