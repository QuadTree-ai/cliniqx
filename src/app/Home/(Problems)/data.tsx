...
export function CardDemo({
  ...
  return (
    <div className="max-w-xs w-full group card">
      <div
        className="cursor-pointer overflow-hidden relative card h-96 rounded-md shadow-xl flex flex-col justify-between p-4 bg-cover"
        style={{ backgroundImage: `url(${image})`, width: '300px' }} // Ensure width is fixed
      >
