...
import { fetchLangchainAnalysis } from '../../utils/langchain'; // Import LangChain function
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Fetch insights from both OpenAI and LangChain
    const [openaiInsights, langchainInsights] = await Promise.all([
      fetchOpenaiAnalysis(textData),
      fetchLangchainAnalysis(textData),
    ]);
