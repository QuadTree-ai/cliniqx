...
const Analytics = lazy(() => import('../app/diagnostics/dashboard/ButtonMenu/analytics/analytics'));
const Share = lazy(() => import('../app/diagnostics/dashboard/ButtonMenu/share/share'));
const Tests = lazy(() => import('../app/diagnostics/dashboard/ButtonMenu/Tests/tests'));
const Invoices = lazy(() => import('../app/diagnostics/dashboard/ButtonMenu/Invoices/Invoices'));
