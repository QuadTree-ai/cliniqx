  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      <div className="w-full h-[890px] -top-60 md:-top-40 flex items-center justify-center bg-red-transparent absolute">
        <Image src="/cliniqx.svg" alt="CliniQX Connection" width={100} height={100} className="mx-auto"/>
      </div>
      <svg width="1440" height="890" viewBox="0 0 1440 890" xmlns="http://www.w3.org/2000/svg" className="absolute -top-60 md:-top-40 w-full">
        {/* Assuming the blurring starts approximately halfway through the total width (720px) */}
        <motion.path
          d="M720 630C920 625, 1100 610, 1440 600"
          stroke="#FFB7C5"
          strokeWidth="2"
          fill="none"
        ...
        />
        <motion.path
          d="M720 580C900 575, 1120 555, 1440 540"
          stroke="#FFDDB7"
          strokeWidth="2"
          fill="none"
          initial={{ pathLength: 0 }}
        ...
        />
        <motion.path
          d="M720 530C930 520, 1150 510, 1440 500"
          stroke="#B1C5FF"
          strokeWidth="2"
          fill="none"
          initial={{ pathLength: 0 }}
