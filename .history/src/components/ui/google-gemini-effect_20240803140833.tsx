...
import CliniqxLogo from "/cliniqx.svg";
      ...
      >
        ...
        {[
          ...
          <path
            key={index}
            d={`
            M0 ${index * 125 + 364}C145.288 ${
              index * 125 + 362.349
            } 195 ${index * 125 + 361.5} 265.5 ${index * 125 + 378}C322 ${
              index * 125 + 391.223
            } 399.182 ${
              index * 125 + 457.5
            } 411 ${index * 125 + 467.5}C424.176 ${
              index * 125 + 478.649
            } 456.916 ${
              index * 125 + 491.677
            } 496.259 ${index * 125 + 502.699}C498.746 ${
              index * 125 + 503.396
            } 501.16 ${
              index * 125 + 504.304
            } 503.511 ${index * 125 + 505.374}C517.104 ${
              index * 125 + 511.558
            } 541.149 ${
              index * 125 + 520.911
            } 551.5 ${index * 125 + 521.236}C571.5 ${
              index * 125 + 521.236
            } 590 ${index * 125 + 498.736} 611.5 ${index * 125 + 498.736}C631.5 ${
              index * 125 + 498.736
            } 652.5 ${index * 125 + 529.236} 669.5 ${
              index * 125 + 528.736
            }C685.171 ${index * 125 + 528.736} 697.81 ${
              index * 125 + 510.924
            } 721.274 ${index * 125 + 501.036}C728.505 ${
              index * 125 + 497.988
            } 736.716 ${
              index * 125 + 497.231
            } 743.812 ${index * 125 + 500.579}C761.362 ${
              index * 125 + 508.857
            } 778.421 ${
              index * 125 + 529.148
            } 794 ${index * 125 + 528.736}C810.375 ${
              index * 125 + 528.736
            } 829.35 ${
              index * 125 + 508.68
            } 848.364 ${index * 125 + 502.179}C854.243 ${
              index * 125 + 500.169
            } 860.624 ${
              index * 125 + 500.802
            } 866.535 ${index * 125 + 502.718}C886.961 ${
              index * 125 + 509.338
            } 898.141 ${
              index * 125 + 519.866
            } 916 ${index * 125 + 520.236}C932.8 ${
              index * 125 + 520.583
            } 934.5 ${
              index * 125 + 510.236
            } 967.5 ${index * 125 + 501.736}C1011.5 ${
              index * 125 + 491
            } 1007.5 ${index * 125 + 493.5} 1029.5 ${
              index * 125 + 480
            }C1069.5 ${
              index * 125 + 453.5
            } 1072 ${index * 125 + 440.442} 1128.5 ${
              index * 125 + 403.5
            }C1180.5 ${index * 125 + 369.5} 1275 ${
              index * 125 + 360.374
            } 1439 ${index * 125 + 364}
          `}
            stroke={stroke}
