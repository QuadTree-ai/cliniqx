...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky top-80", className)}>
      ...
      <div className="relative w-full h-[890px] -top-60 md:-top-40">
        <svg
          width="1440"
          height="890"
        ...
        <Image
          ...
          width={100}
          height={100}
          className="absolute left-0" // Adjust positioning here
          style={{ top: '445px', transform: 'translateY(-50%)' }}  // Center the image vertically at the start of the paths
        />
      </div>
    </div>
  );
