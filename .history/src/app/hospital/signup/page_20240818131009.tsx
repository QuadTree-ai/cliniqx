    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-6">
      <div className="bg-gray-900 bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-8 max-w-5xl w-full border border-gray-700">
        ...
        <form onSubmit={handleSignUpClick} className="grid gap-6 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
          ...
          {/* Departments */}
          <div className="col-span-2 xl:col-span-3">
            {renderInputField("Departments", "departments", signupData.departments.join(', '), (e) => handleArrayChange("departments", e.target.value), "text", "Enter departments separated by commas")}
          </div>

          {/* Medical Equipment */}
          <div className="col-span-2 xl:col-span-3">
            {renderInputField("Medical Equipment", "medicalEquipment", signupData.medicalEquipment.join(', '), (e) => handleArrayChange("medicalEquipment", e.target.value), "text", "Enter medical equipment separated by commas")}
          </div>

          {/* Insurance Providers */}
          <div className="col-span-2 xl:col-span-3">
            {renderInputField("Insurance Providers", "insuranceProviders", signupData.insuranceProviders.join(', '), (e) => handleArrayChange("insuranceProviders", e.target.value), "text", "Enter insurance providers separated by commas")}
          </div>

          {/* Available Specialties */}
          <div className="col-span-2 xl:col-span-3">
            {renderInputField("Available Specialties", "availableSpecialties", signupData.availableSpecialties.join(', '), (e) => handleArrayChange("availableSpecialties", e.target.value), "text", "Enter specialties separated by commas")}
          </div>
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
              <DropzoneField label="Certificate of Registration" fieldName="certificateOfRegistration" uploadedFiles={uploadedFiles} setUploadedFiles={setUploadedFiles} />
              <DropzoneField label="License" fieldName="license" uploadedFiles={uploadedFiles} setUploadedFiles={setUploadedFiles} />
              <DropzoneField label="Pharmacy License" fieldName="pharmacyLicense" uploadedFiles={uploadedFiles} setUploadedFiles={setUploadedFiles} />
              <DropzoneField label="Clinical Establishment License" fieldName="clinicalEstablishmentLicense" uploadedFiles={uploadedFiles} setUploadedFiles={setUploadedFiles} />
              <DropzoneField label="Bio-medical Waste Authorization" fieldName="bioMedicalWasteAuthorization" uploadedFiles={uploadedFiles} setUploadedFiles={setUploadedFiles} />
            </div>
          </div>
