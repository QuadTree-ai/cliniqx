...
export default function HospitalSignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-6">
      <div className="bg-gray-900 bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-8 max-w-4xl w-full border border-gray-700">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-center text-gray-300 mb-6">
            Join our platform to enhance your hospitals operational efficiency. Fill out the form below to get started.
          </p>
        </div>
