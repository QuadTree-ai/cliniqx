      ...
      case 'text':
        return (
          <Controller
            ...
            control={control}
            render={({ field: { onChange, value } }) => (
              <Textarea {...commonProps} onChange={onChange} value={typeof value === 'string' ? value : ''} placeholder={field.placeholder} />
            )}
          />
        );
      case 'checkbox':
          ...
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <Input
                ...
                value={typeof value === 'string' || typeof value === 'number' || Array.isArray(value) ? value : undefined}
                onChange={onChange}
