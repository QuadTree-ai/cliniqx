...
export default function HospitalSignupPage() {
  ...
  const renderInputField = (label: string, name: string, value: string | number, onChange: (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => void, type = "text", placeholder = '') => (
    <div className="mb-6">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-6">
      <div className="bg-gray-900 bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-10 max-w-6xl w-full border border-gray-700">
        ...
        <form onSubmit={handleSignUpClick} className="grid gap-8 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
          {/* Hospital Name */}
          <div className="col-span-2 xl:col-span-3">
            {renderInputField("Hospital Name", "hospitalName", signupData.hospitalName, (e) => handleChange(e))}
          </div>
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {Object.entries(signupData.administrator).map(([key, value]) =>
                renderInputField(key, key, value as string, (e) => handleChange(e, 'administrator'))
              )}
            </div>
          </div>
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {Object.entries(signupData.emergencyContact).map(([key, value]) =>
                renderInputField(key, key, value as string, (e) => handleChange(e, 'emergencyContact'))
              )}
            </div>
          </div>

          {/* Number of Beds */}
          {renderInputField("Number of Beds", "numberOfBeds", signupData.numberOfBeds, (e) => handleChange(e), "number")}
          ...
          {renderInputField(
            ...
            (e: { target: { value: string } }) => handleArrayChange("services", e.target.value),
            "text",
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {Object.entries(signupData.staffCapacity).map(([key, value]) =>
                renderInputField(key, key, value as number, (e) => handleChange(e, 'staffCapacity'), "number")
              )}
            </div>
          </div>
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            {renderInputField(
              ...
              (e: { target: { value: string } }) => handleArrayChange("hospitalFacilities", e.target.value),
              "text",
          ...
          <div className="col-span-2 xl:col-span-3">
            {renderInputField(
              ...
              (e: { target: { value: string } }) => handleArrayChange("certifications", e.target.value),
              "text",
          ...
          <div className="col-span-2 xl:col-span-3">
            {renderInputField(
              ...
              (e: { target: { value: string } }) => handleArrayChange("affiliations", e.target.value),
              "text",
          ...
          <Button
            type="submit"
            className="w-full py-3 text-lg font-bold text-white bg-gradient-to-r from-green-500 to-blue-600 rounded-lg shadow-lg hover:bg-gradient-to-l focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300 col-span-2 xl:col-span-3"
          >
            Sign Up
          </Button>
        </form>
