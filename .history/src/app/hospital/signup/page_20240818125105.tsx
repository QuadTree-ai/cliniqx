...
export default function HospitalSignupPage() {
  ...
  const {
    ...
    handleChange,
    handleArrayChange,
    handleBooleanChange, // Now correctly included
    handleSubmit,
  ...
  // Handling the dropzone file uploads for certificates and licenses
      ...
      <div className="bg-gray-900 bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-10 max-w-6xl w-full border border-gray-700">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-center text-gray-300 mb-6">
            Join our platform to enhance your hospital&apos;s operational
            efficiency. Fill out the form below to get started.
          </p>
        </div>
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {Object.entries(signupData.emergencyContact).map(([key, value]) =>
                renderInputField(
                  ...
                  value as string,
                  (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
                    handleChange(e, "emergencyContact")
                )
              )}
            </div>
          </div>
          ...
          <div className="col-span-2 xl:col-span-3">
            ...
            {renderInputField(
              ...
              (e: { target: { value: string } }) =>
                handleArrayChange("hospitalFacilities", e.target.value),
              "text",
          ...
          <div className="col-span-2 xl:col-span-3">
            {renderInputField(
              ...
              (e: { target: { value: string } }) =>
                handleArrayChange("affiliations", e.target.value),
              "text",
                ...
                <label key={service} className="inline-flex items-center">
                  <Checkbox
                    ...
                    onCheckedChange={(checked: boolean) =>
                      handleBooleanChange(
                        service as keyof typeof signupData,
                        checked
                      )
                    }
