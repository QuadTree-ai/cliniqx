...
import { HospitalSignupData, formConfig, DynamicFieldConfig, hospitalSignupSchema, FIELD_NAMES } from './HospitalSignupData';
      ...
      case 'checkbox':
        return (
          <Controller
            ...
            control={control}
            render={({ field: { onChange, value } }) => (
              <Checkbox checked={value} onCheckedChange={onChange} {...commonProps} />
            )}
          />
        );
      default:
