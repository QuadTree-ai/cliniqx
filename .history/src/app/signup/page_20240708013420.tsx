    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-4xl w-full">
        ...
        <form onSubmit={handleSignUpClick} className="grid gap-6 grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex items-center col-span-1 md:col-span-2 space-x-2">
            <Checkbox
              id="terms"
          ...
          <Button
            type="submit"
            className="w-full text-white bg-blue-600 rounded-md py-2 mt-4 col-span-1 md:col-span-2"
          >
            Sign Up
          </Button>
        </form>
