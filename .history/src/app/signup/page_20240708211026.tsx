...
const signupOptions = [
  ...
  },
  {
    ...
    imageSrc: "/hospital.jpeg"
  },
  {
    id: "doctor-signup",
    title: "I'm a Doctor",
    link: "/doctor-signup",
    description: "Join as a doctor to provide personalized care and manage your patients efficiently.",
    signupText: "Doctor Signup",
    imageSrc: "/doctor.jpeg"
  },
  {
    id: "customer-signup",
    ...
    imageSrc: "/customer.jpeg"  // Assuming there's an image for customer as well
  },
];
...
const SignupNavItem = ({ title, link, description, signupText, imageSrc }) => (
  <NavigationMenuItem>
    ...
    <NavigationMenuContent className="p-4 bg-white rounded shadow-lg mt-2 flex items-center">
      <img src={imageSrc} alt={`${signupText} Image`} className="w-16 h-16 rounded-full mr-4" />
      <div>
