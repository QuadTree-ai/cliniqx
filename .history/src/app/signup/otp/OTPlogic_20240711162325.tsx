...
export const EMAIL_OTP_HEADER = "Phone OTP";
export const PHONE_OTP_HEADER = "Phone OTP";
export const EMAIL_OTP_DESCRIPTION = "Please enter the OTP sent to your phone.";
export const PHONE_OTP_DESCRIPTION = "Please enter the OTP sent to your phone.";
export const RESEND_EMAIL_BUTTON_LABEL = "Resend Phone OTP";
