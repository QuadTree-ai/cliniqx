...
const FormSchema = z.object({
  pin0: z.string().min(1, { message: "Required" }),
  pin1: z.string().min(1, { message: "Required" }),
  pin2: z.string().min(1, { message: "Required" }),
  pin3: z.string().min(1, { message: "Required" }),
  pin4: z.string().min(1, { message: "Required" }),
  pin5: z.string().min(1, { message: "Required" }),
});
