      ...
      <nav className="bg-white shadow-md fixed w-full z-10">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <Link href="#customer-signup" className="text-gray-600 hover:text-gray-800">
              Customer Signup
            </Link>
            <Link href="#pharmacy-signup" className="text-gray-600 hover:text-gray-800">
              Pharmacy Signup
            </Link>
            <Link href="#hospital-signup" className="text-gray-600 hover:text-gray-800">
              Hospital Signup
            </Link>
          </div>
        </div>
