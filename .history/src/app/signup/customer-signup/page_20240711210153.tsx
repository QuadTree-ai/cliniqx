...
import { ToastProvider, Toast, ToastTitle, ToastDescription, ToastViewport, ToastClose } from "@/components/ui/toast";
...
export default function CustomerSignup() {
  ...
  return (
    <ToastProvider>
      ...
      <ToastViewport />
      {showToast && (
        <Toast onOpenChange={(open) => setShowToast(open)}>
          <div className="flex">
            <div className="flex-1">
              <ToastTitle>Account Created</ToastTitle>
              <ToastDescription>Your account has been successfully created.</ToastDescription>
            </div>
            <ToastClose />
          </div>
        </Toast>
