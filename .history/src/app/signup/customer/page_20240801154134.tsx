...
import { formFields } from "./FormConstants"; // Ensure this path is correct

function FormField({ fieldKey, value, handleNameChange }) {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid gap-4">
                            {['firstName', 'lastName', 'email', 'phone', 'password'].map(key => (
                                <FormField key={key} fieldKey={key} value={formData[key]} handleNameChange={handleInputChange} />
                            ))}
