...
const DropdownItem = ({ title, link, description, signupText, imgSrc }) => (
  <div className="group relative">
    ...
    <div className="absolute left-0 mt-2 w-64 bg-white rounded-lg shadow-lg opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300">
      <div className="p-4 flex">
        <div className="bg-gray-200 p-4 rounded-l flex items-center justify-center">
          <img src={imgSrc} alt={title} className="w-16 h-16 object-cover rounded-full" />
        </div>
        <div className="p-4">
