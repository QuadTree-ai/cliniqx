...
const SignupNavItem = ({ title, link, description, signupText, imgSrc }) => (
  <NavigationMenuItem>
    ...
    <NavigationMenuContent className="p-4 bg-white rounded shadow-lg mt-2 grid grid-cols-1 md:grid-cols-3 gap-4">
      <img src={imgSrc} alt={title} className="w-full h-32 object-cover rounded-md col-span-1" />
