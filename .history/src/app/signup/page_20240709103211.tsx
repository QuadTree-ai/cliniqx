...
export default function MainSignup() {
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="pt-24">
        {/* Customer Section */}
        <section className="container mx-auto flex flex-col items-center justify-center py-12 space-y-6">
        ...
        <div className="relative w-full h-24 flex items-center justify-center">
          <CurvedArrow from={{ x: 50, y: 50 }} to={{ x: 250, y: 0 }} color="black" width={2} />
        </div>
