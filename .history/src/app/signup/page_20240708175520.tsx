...
import { HoverCard } from "@/components/ui/hover-card"; // Ensure this component supports className for styling
...
const signupOptions = [
  {
    ...
    imgSrc: "/path/to/customer-image.jpg", // Add your image path
  },
  {
    id: "pharmacy-signup",
    ...
    imgSrc: "/path/to/pharmacy-image.jpg", // Add your image path
  },
  {
    id: "hospital-signup",
    ...
    imgSrc: "/path/to/hospital-image.jpg", // Add your image path
  },
];
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-8">
            {signupOptions.map((option) => (
              <div key={option.id} className="w-full max-w-md p-6 transition-all duration-300 hover:scale-105">
                <HoverCard>
