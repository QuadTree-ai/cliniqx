    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center py-12 space-y-6 relative bg-gradient-to-r from-blue-100 to-blue-300">
        <div className="container mx-auto flex items-center justify-center space-x-6">
          <Card className="relative overflow-hidden w-1/3 transition-transform duration-500 hover:scale-105 rounded-lg shadow-lg">
            <img
              src="/customer.jpeg"
              alt="I'm a Customer"
        ...
        <div className="absolute bottom-12 w-2/3 bg-white p-4 rounded-lg shadow-md text-center transition-opacity duration-500 hover:opacity-90">
          <p className="text-xl text-gray-700">
            If you are a business owner or medical professional
          </p>
        </div>
        <div className="absolute bottom-0 w-full flex justify-center">
          <CurvedArrow from={{ x: 50, y: 0 }} to={{ x: 50, y: 300 }} color="black" width={2} />
        </div>
      </section>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center py-12 space-y-6">
        <div className="container mx-auto flex items-center justify-center space-x-6">
          {signupOptions.map((option) => (
            <div
              key={option.id}
              className="relative overflow-hidden w-1/3 transition-all duration-300 rounded-lg shadow-lg group"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-75 group-hover:opacity-100 transition-opacity duration-300 p-6 flex flex-col justify-end">
                <div className="flex flex-col items-start space-y-2">
                  ...
                  <Link href={option.link} passHref>
                    <Button className="mt-4 rounded-md py-3 px-8 text-white bg-yellow-600 hover:bg-yellow-700 transition-colors duration-200 flex items-center space-x-2 opacity-0 group-hover:opacity-100">
