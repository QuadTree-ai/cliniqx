...
export default function MainSignup() {
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      {/* Customer Section */}
      <section id="customer-section" className="min-h-screen flex flex-col items-center justify-center py-12 space-y-6 relative bg-gradient-to-r from-blue-100 to-blue-300">
        <div className="container mx-auto flex items-center justify-center space-x-8">
          <Card className="relative overflow-hidden w-2/3 max-w-3xl transition-transform duration-500 rounded-lg shadow-lg">
            <img
              src="/customer.jpeg"
              alt="I'm a Customer"
