...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-20 top-0 bg-white shadow-lg mb-4">
      <div className="container mx-auto px-8 py-4 flex justify-between items-center">
        <Logo className="w-32 h-auto md:w-40 lg:w-48" />
        <div className="hidden md:flex space-x-8 items-center">
          <NavMenu />
          <Link href="/login" passHref>
            <Button className="text-white bg-yellow-500 hover:bg-yellow-600 transition-colors duration-200 text-xl px-6 py-2 rounded-md">
              Login
            </Button>
          </Link>
          <Link href="/signup/customer-signup" passHref>
            <Button className="text-white bg-black hover:bg-gray-800 transition-colors duration-200 flex items-center space-x-2 text-xl px-6 py-2 rounded-md">
              <span>Try Now</span>
