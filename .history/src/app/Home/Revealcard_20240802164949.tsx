...
export function TextRevealCardPreview() {
  return (
    <div className="flex items-center justify-center h-[90vh] w-full px-4 py-10 sm:px-6 sm:py-14 md:px-8 md:py-16 lg:px-10 lg:py-20">
      ...
      >
        <div className="p-6 sm:p-8 md:p-10 lg:p-12 text-center space-y-4">
          {/* Used space-y-4 to create consistent vertical spacing */}
          <TextRevealCardTitle className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white">
            Experience the Difference in Care
          </TextRevealCardTitle>
          <TextRevealCardDescription className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-300">
