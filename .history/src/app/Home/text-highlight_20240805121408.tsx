...
const TextHighlight: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-black via-gray-900 px-4">
      <div className="text-center font-bold leading-none space-y-6 md:space-y-8 lg:space-y-12
