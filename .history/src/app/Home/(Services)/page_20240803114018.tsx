...
// Import SVG as a static asset using Next.js Image component
const cliniqxLogoSrc = "/cliniqx.svg"; // Path to SVG in the public folder
    ...
    card={{
      ...
      content: (
        <div className="p-6 bg-white bg-opacity-80 backdrop-filter backdrop-blur-md rounded-lg shadow-lg">
          {/* Displaying the CliniQX logo with the Next.js Image component */}
          <Image
            src={cliniqxLogoSrc} // Reference the path set above
            alt="CliniQX Logo"
