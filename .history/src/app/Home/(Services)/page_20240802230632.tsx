...
const ServiceCardComponent = ({ card, index }: { card: ServiceCard, index: number }) => (
  <Card
    card={{
      ...
      category: "Healthcare",
      content: (
        <div className="p-6 bg-opacity-80 backdrop-filter backdrop-blur-md rounded-lg shadow-lg">
  ...
  return (
    <section className="bg-gray-50 text-gray-800 py-16">
      <div className="container mx-auto px-6">
        <h2 className="max-w-7xl pl-4 mx-auto text-2xl md:text-5xl font-bold text-neutral-800 dark:text-neutral-200 mb-10">
          Our Services
        </h2>
