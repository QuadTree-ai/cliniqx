      ...
      <div className="container mx-auto px-4">
        {services.map((service, index) => (
          <section key={index} className="mb-12 relative overflow-hidden">
            ...
            <CardContent className="mt-4 bg-white rounded-xl p-6 shadow transition-shadow duration-300 ease-in-out hover:shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {service.subServices.map((subService, subIndex) => (
                  <Card key={subIndex} className="bg-gray-100 p-4 rounded-xl shadow-sm hover:shadow-md transition-transform duration-300 ease-in-out">
