...
const Service: React.FC = () => {
  ...
  return (
    <section className="text-gray-800 py-16 bg-gray-300 dark:bg-gray-900">
      <div className="container mx-auto px-6">
        <h2 className="max-w-7xl mx-auto text-center text-4xl md:text-6xl font-bold text-gray-800 dark:text-white mb-12">
          Our Services
        </h2>
