...
const initialStatistics = [
  {
    name: "Heart Disease",
    ratePerSecond: 0.033,
    imageUrl: "/Problems/HeartDisease.jpg",
  },
  {
    name: "Injury",
    ratePerSecond: 0.05,
    imageUrl: "/Problems/Injury.jpg",
  },
  {
    name: "Respiratory Disease",
    ratePerSecond: 0.025,
    imageUrl: "/Problems/RespiratoryDisease.jpg",
  },
  {
    name: "Hospital Admission",
    ratePerSecond: 0.067,
    imageUrl: "/Problems/HospitalAdmission.jpg",
  },
  {
    name: "Cancer Detected",
    ratePerSecond: 0.0083,
    imageUrl: "/Problems/CancerDetected.jpg",
  },
  {
    name: "Diabetes",
    ratePerSecond: 0.02,
    imageUrl: "/Problems/Diabetes.jpg",
  },
  {
    name: "Emergency Visits",
    ratePerSecond: 0.1,
    imageUrl: "/Problems/EmergencyVisits.jpg",
  },
  {
    name: "Mental Health Issues",
    ratePerSecond: 0.042,
    imageUrl: "/Problems/MentalHealthIssues.jpg",
  },
];
    ...
    <div className="flex flex-wrap justify-center gap-8 p-4">
      {statistics.map((stat, index) => (
        <CardDemo
          ...
          imageUrl={stat.imageUrl}  // Using the image URL directly from the stats
