...
const initialStatistics: Statistic[] = [
  ...
  { name: "Extra Card for Continuous Effect", ratePerSecond: 0.042, image: "/Problems/MentalHealthIssues.jpg", value: 0 }
];
...
export function CardsContainer() {
  ...
  return (
    <section className="relative overflow-hidden w-full min-h-screen flex flex-col justify-center items-center py-12 px-8 bg-gray-900">
      ...
      <div className="marquee w-full overflow-x-hidden">
      ...
      <style jsx>{`
        ...
        .marquee-content {
          display: flex;
          gap: 2rem; // ensure space between cards
