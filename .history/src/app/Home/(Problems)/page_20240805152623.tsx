...
const initialStatistics = [
  {
    ...
    ratePerSecond: 0.033,
    icon: HeartPulse,
    description: "Cases per second globally",
  },
  {
    name: "Injury",
    ratePerSecond: 0.05,
    icon: Activity,
    description: "Injury reports per second",
  },
  {
    name: "Respiratory Disease",
    ratePerSecond: 0.025,
    icon: Wind,
    description: "Respiratory cases detected per second",
  },
  {
    name: "Hospital Admission",
    ratePerSecond: 0.067,
    icon: Hospital,
    description: "Hospital admissions per second",
  },
  {
    name: "Cancer Detected",
    ratePerSecond: 0.0083,
    icon: Radiation,
    description: "New cancer cases per second",
  },
  {
    name: "Diabetes",
    ratePerSecond: 0.02,
    icon: Thermometer,
    description: "Diabetes diagnoses per second",
  },
  {
    name: "Emergency Visits",
    ratePerSecond: 0.1,
    icon: AlertCircle,
    description: "Emergency department visits per second",
  },
  {
    name: "Mental Health Issues",
    ratePerSecond: 0.042,
    icon: Headset,
    description: "Mental health issue reports per second",
  },
];
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 p-2 md:p-4">
        {statistics.map((stat, index) => (
          ...
          >
            ...
            <p className="text-sm md:text-md text-gray-400 mb-2">{stat.description}</p>
            <p
