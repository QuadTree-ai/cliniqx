...
export function CardsContainer() {
  ...
  return (
    <>
      <div className="text-center mt-48 mb-42">
        <h1 className="text-5xl font-bold text-white mb-8 mt-12">Health Impact Statistics</h1>
        <p className="text-lg text-gray-400 mb-12">Live updates on health-related incidents</p>
      </div>
