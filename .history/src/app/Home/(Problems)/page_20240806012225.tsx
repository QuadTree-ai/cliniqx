  ...
  return (
    <>
      <div className="text-center p-12">
        ...
        <p className="text-xl text-gray-300 mb-12">Live updates on health-related incidents, providing real-time data to monitor trends and prompt responses.</p>
      </div>
      <div className="flex flex-wrap justify-center gap-12 p-12 bg-gray-900 rounded-lg shadow-xl">
