...
export function CardsContainer() {
  ...
  return (
    <section className="relative overflow-hidden mt-16 mb-8 py-12 px-8">
      ...
      <style jsx>{`
        ...
        .marquee-content {
          display: flex;
          gap: 2rem;  // Added gap for spacing between cards
          width: calc(100% + 2000px); // Increased width to accommodate extra spacing
        }
        @keyframes marquee {
