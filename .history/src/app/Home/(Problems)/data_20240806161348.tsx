...
export function CardDemo({
  ...
  return (
    <div className="max-w-xs w-full group card mb-1">
      <div
        className="cursor-pointer overflow-hidden relative card h-96 rounded-md shadow-xl max-w-sm mx-auto flex flex-col justify-between p-4 bg-cover mb-4"
