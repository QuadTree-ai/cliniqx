...
const TextHighlight: React.FC = () => {
  ...
  const getLineVariants = (delay: number) => ({
    ...
    visible: { opacity: 1, color: "#FFFFFF", scale: 1.05, transition: { delay, duration: 0.1 } },
  });

  return (
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="text-center font-bold text-8xl leading-tight space-y-8 text-gray-400" style={{ minHeight: '150vh' }}>
        <motion.span
          ref={line1Ref}
          className="block"
