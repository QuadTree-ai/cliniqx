...
const HealthLaunchpad = () => {
  return (
    <div className="w-full h-screen flex justify-center items-cente">
      <Card className="w-4/5 h-4/5 max-w-none shadow-2xl flex flex-col justify-center items-center bg-white rounded-lg">
