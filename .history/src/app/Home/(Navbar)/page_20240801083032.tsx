    ...
    <nav className="w-full z-50 top-0 bg-white relative">
      <div className="container mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          <NavMenu />
          <Link href="/login/user/page" passHref> {/* Updated path for user login */}
          ...
          <Link href="/signup/customer/page" passHref> {/* Ensured clarity in path */}
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col items-center bg-gray-50 py-4 space-y-4">
          <NavMenu />
          <Link href="/login/user/page" passHref>
          ...
          <Link href="/signup/customer/page" passHref>
