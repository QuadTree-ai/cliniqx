    ...
    <section id="features" className="py-12 bg-gray-100">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 p-8">
          <h2 className="text-6xl font-semibold text-gray-800 mb-4">Introducing</h2>
          <h1 className="text-7xl font-bold text-gray-800 mb-4 leading-tight">India's first credit card for healthcare</h1>
