...
const Hero = () => {
  return (
    <section className="min-h-screen flex flex-col items-start justify-center py-2 bg-gray-50 relative">
      <Marquee />
      <div className="container mx-auto flex flex-col md:flex-row items-center pt-24 px-4 md:px-8">
        <div className="md:w-2/3 mb-8 md:mb-0 text-center md:text-left">
          ...
          <Button className="mt-4 text-md sm:text-lg md:text-xl px-6 sm:px-10 py-3 sm:py-4 text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200 rounded-full">
            Learn More
          </Button>
        </div>
        <div className="md:w-1/3 flex justify-center md:justify-end mt-8 md:mt-0">
          <Image src={Human} alt="3D Human" width={400} height={400} className="max-w-full h-auto" />
        </div>
      </div>
    </section>
  );
