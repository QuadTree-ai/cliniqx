...
const Marquee = () => {
  return (
    <div className="overflow-hidden bg-purple-100 p-4 rounded-lg shadow-md w-full">
      <div className="animate-marquee text-purple-700 flex">
        {messages.map((message, index) => (
          <span key={index} className="flex items-center min-w-full justify-center">
            {message}
          </span>
        ))}
      </div>
