...
const Marquee = () => {
  return (
    <div className="w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-4 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        <div className="animate-marquee text-white flex whitespace-nowrap space-x-12">
