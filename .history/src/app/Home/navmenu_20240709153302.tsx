    ...
    content: (
      <>
        ...
        <div className="mt-4 space-y-2">
          <Link href="/about/history" passHref legacyBehavior>
            <a className="block text-blue-700">Our History</a>
          </Link>
          <Link href="/about/team" passHref legacyBehavior>
            <a className="block text-blue-700">Our Team</a>
          </Link>
          <Link href="/about/careers" passHref legacyBehavior>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <div className="mt-4 space-y-2">
          <Link href="/program/benefits" passHref legacyBehavior>
            <a className="block text-purple-700">Program Benefits</a>
          </Link>
          <Link href="/program/apply" passHref legacyBehavior>
            <a className="block text-purple-700">How to Apply</a>
          </Link>
          <Link href="/program/faq" passHref legacyBehavior>
