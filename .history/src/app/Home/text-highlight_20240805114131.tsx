...
const TextHighlight: React.FC = () => {
  ...
  const handleScroll = () => {
    const triggerHeight = window.innerHeight / 1.5;  // Adjust trigger point to better fit the increased section length
  ...
  return (
    <div className="min-h-[150vh] flex items-center justify-center bg-black">  // Increased minimum height and centered content
