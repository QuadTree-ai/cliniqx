        ...
        <ScrollArea className="w-full whitespace-nowrap rounded-md border">
          <div className="flex w-max space-x-6 p-4">
            {services.map((service, index) => (
              <div
                key={index}
                className="shrink-0 bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300"
              >
                <div className="overflow-hidden rounded-full w-16 h-16 mb-4 mx-auto">
                  <Image
                    src={service.image}
                    alt={service.title}
