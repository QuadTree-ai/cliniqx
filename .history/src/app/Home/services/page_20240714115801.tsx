...
import cliniqxclinic from "/public/cliniqx clinic.svg"; // Add new image for clinic
...
const Service = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-50 via-purple-100 to-purple-50">
      <div className="container mx-auto relative z-10">
        <div className="relative w-full h-screen flex items-center justify-center">
          ...
          {services.map((service, index) => (
            <div
              key={index}
              className="absolute service-item transition-transform duration-500 ease-in-out"
