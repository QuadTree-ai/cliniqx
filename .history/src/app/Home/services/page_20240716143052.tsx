      ...
      <div className="container mx-auto relative z-10 flex flex-col items-center justify-center space-y-8">
        ...
        <div className="w-full flex flex-wrap justify-center items-center space-x-6 space-y-6 p-4">
          {services.map((service, index) => (
            <div
              key={index}
              className="flex flex-col items-center p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300"
            >
              <div className="relative w-20 h-20 mb-4 mx-auto flex items-center justify-center"></div>
