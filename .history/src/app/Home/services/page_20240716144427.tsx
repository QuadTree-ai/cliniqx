  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white py-12">
      <div className="container mx-auto flex flex-col items-center justify-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl p-4">
          {services.map((service, index) => (
            <Card key={index} className="flex flex-col items-center justify-center p-6 hover:shadow-2xl transition-shadow duration-300 bg-white text-gray-800">
