...
const Hero = () => {
  return (
    <div className="relative z-10 flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-black">
      <ContainerScroll
        titleComponent={
          <div className="text-center px-4 py-16 sm:px-8 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-32 xl:px-32 xl:py-40">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-200 mt-4">
