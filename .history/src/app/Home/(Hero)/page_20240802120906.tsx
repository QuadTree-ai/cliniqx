        ...
        titleComponent={
          <div className="text-center px-24 py-32">
            ...
            <div className="flex justify-center gap-10 mt-16">
              <Button
                className="text-white font-bold py-3 px-8 rounded transition duration-300 ease-in-out flex items-center justify-center"
                style={{ background: '#136D94' }}
                duration={3000}
              >
