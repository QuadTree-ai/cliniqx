      ...
      <ContainerScroll
        titleComponent={
          <div className="text-center px-4 py-16 sm:px-8 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-32 xl:px-32 xl:py-40">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-gray-200 mt-10 mb-8 sm:mt-12 sm:mb-10 md:mt-16 md:mb-12 lg:mt-20 lg:mb-14 xl:mt-24 xl:mb-16">
              Redefining health care with the power of Medical Artificial Intelligence
            </p>
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-10 md:mt-12">
              <Link href="/signup/customer" passHref>
                <HoverBorderGradient
                  ...
                  as="button"
                  className="dark:bg-black bg-white text-black dark:text-white font-bold py-2 px-4 sm:py-3 sm:px-6 md:py-3 md:px-8 flex items-center justify-center space-x-2"
                >
