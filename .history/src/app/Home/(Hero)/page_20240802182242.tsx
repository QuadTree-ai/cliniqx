            ...
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mt-8 sm:mt-10 md:mt-12">
              <Link href="/signup/customer" passHref>
                <HoverBorderGradient
                  ...
                  as="button"
                  className="transition duration-300 ease-in-out bg-white text-black font-bold py-2 px-4 sm:py-3 sm:px-6 md:py-3 md:px-8 flex items-center justify-center border-2 border-transparent hover:border-gradient-r from-[#6ee7b7] to-[#3b82f6]"
                >
