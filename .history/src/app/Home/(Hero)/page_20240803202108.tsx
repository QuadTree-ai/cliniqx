        ...
        titleComponent={
          <div className="text-center px-8 py-16 sm:px-12 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-28 xl:px-32 xl:py-32">
            ...
            <h4 className="text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl text-gray-400 mt-4 mb-8 leading-snug">
              CliniQX offers an advanced Electronic Health Records (EHR) system,
              streamlining patient care and enhancing data management. Simplify
              documentation, improve accessibility, and ensure compliance,
              allowing healthcare providers to focus on delivering better
              patient outcomes.
            </h4>
