      ...
      <ContainerScroll
        titleComponent={
          <div className="text-center px-8 py-16 sm:px-12 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-28 xl:px-32 xl:py-32">
            <div className="mb-16 flex justify-center">  {/* Increased spacing here */}
              <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
                  Next-Generation connected healthcare platform
                </span>
              </button>
            </div>
            <div className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 leading-snug mb-10">  {/* Adjusted spacing here */}
            ...
            <h4 className="text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl text-gray-400 mt-12 mb-16 leading-snug">  {/* Increased top and bottom margin */}
            ...
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-20">  {/* Increased spacing here */}
            ...
            <p className="text-sm text-gray-400 mt-12 mb-8 leading-snug">  {/* Increased top margin */}
