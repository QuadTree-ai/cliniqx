        ...
        titleComponent={
          <div className="text-center px-24 py-32"> {/* Increased padding for more space */}
            ...
            <div className="flex justify-center gap-10 mt-16"> {/* Increased gap and margin-top for more space */}
              ...
              <button className="bg-[#136D94] border-2 border-[#136D94] text-[#136D94] font-bold py-3 px-8 rounded hover:bg-[#136D94] hover:transition duration-300 ease-in-out flex items-center justify-center">
