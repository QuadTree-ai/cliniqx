        ...
        <div className="absolute inset-0 flex items-center justify-center z-0">
          <div className="container mx-auto flex flex-col items-center pt-24 px-4 md:px-8 z-10 relative">
            <div className="w-full mb-8 text-center">
              ...
              <p className="text-lg sm:text-xl text-neutral-400 mt-4">
                Our advanced AI solutions are designed to enhance healthcare efficiency,
                reduce errors, and improve outcomes for patients worldwide.
              </p>
            </div>
          </div>
        </div>
