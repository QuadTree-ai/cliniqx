...
const Hero = () => {
  return (
    <div className="relative z-10 flex items-center justify-center min-h-screen mb-48">
          ...
          <div className="text-center px-8 py-16 sm:px-12 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-28 xl:px-32 xl:py-32">
            <div className="mb-24 flex justify-center">
              <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                Next-Generation connected healthcare platfrom
                </span>
              </button>
            </div>
      ...
      >
        <div className="relative w-full h-64 sm:h-96 md:h-[36rem] lg:h-[40rem] xl:h-[44rem] flex items-center justify-center mb-12">
          <Image
            src="/3d.svg"
            alt="Muscular System"
            layout="fill"
