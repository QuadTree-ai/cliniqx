      ...
      <ContainerScroll
        titleComponent={
          <div className="text-center px-6 py-12 sm:px-10 sm:py-16 md:px-14 md:py-20 lg:px-20 lg:py-24 xl:px-28 xl:py-28">
            ...
            <h4 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-gray-200 mt-6 mb-10 leading-relaxed">
            CliniQX offers an advanced Electronic Health Records (EHR) system, streamlining patient care and enhancing data management. Simplify documentation, improve accessibility, and ensure compliance, allowing healthcare providers to focus on delivering better patient outcomes.
            </h4>
