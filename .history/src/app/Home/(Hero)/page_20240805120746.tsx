        ...
        titleComponent={
          <div className="text-center px-8 py-16 sm:px-12 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-28 xl:px-32 xl:py-32">
            ...
            <div className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 leading-snug mb-6">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-extrabold mb-5">
                Personal AI
              </h1>
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-extrabold mb-8">
                Healthcare Assistant
              </h1>
            </div>
            <h4 className="text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl text-gray-400 mt-6 mb-12 leading-snug">
