      ...
      <ContainerScroll
        titleComponent={
          <div className="text-center px-8 py-16 sm:px-12 sm:py-20 md:px-16 md:py-24 lg:px-24 lg:py-28 xl:px-32 xl:py-32">
            ...
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-12"> {/* Increased bottom margin */}
            ...
            <p className="text-sm text-gray-400 mt-10 mb-8 leading-snug"> {/* Increased top margin */}
