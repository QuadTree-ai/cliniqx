...
export default function Navbar() {
  ...
  const inactiveButtonStyles =
    "text-black bg-gray-100 hover:bg-gray-200 hover:text-blue-600 shadow-sm";
  ...
  return (
    <div className="bg-transparent flex items-center justify-between px-6 py-4">
      ...
      <div className="flex items-center space-x-6">
        <Button
          variant="ghost"
          className={`${inactiveButtonStyles} px-3 py-2 rounded-lg`}
        >
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Avatar
              className={`${inactiveButtonStyles} w-12 h-12 cursor-pointer rounded-full`}
            >
