...
export default function Navbar() {
  ...
  const buttonBaseStyle = "flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors duration-300 ease-in-out shadow-sm";
  const buttonActiveStyle = "bg-gray-600 text-white shadow-lg";
  const buttonInactiveStyle = "bg-white text-black hover:bg-gray-300 hover:text-blue-600 hover:shadow-lg";
