...
import { iconsMap } from '../humanmodel/icon/anatomyicons';

type DataUploadProps = {
  onUploadSuccess: (insights: Array<{ part: keyof typeof iconsMap; problem: string; severity: 'low' | 'moderate' | 'high' }>) => void;
};
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        onUploadSuccess(data.insights); // Send insights to the parent component
