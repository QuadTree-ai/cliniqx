  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center">
      ...
      <div className="flex md:flex-col justify-center items-center">
        <button
          onClick={handleFlip}
          className="px-4 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-gray-700 transition-all duration-300 flex items-center shadow-lg"
        >
      ...
      <div className="flex md:flex-col justify-center items-center">
        <button
          onClick={handleFlip}
          className="px-4 py-2 bg-gray-600 text-white font-semibold rounded-lg hover:bg-gray-700 transition-all duration-300 flex items-center shadow-lg"
        >
