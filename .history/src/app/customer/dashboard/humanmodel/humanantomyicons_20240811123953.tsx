...
import { Heart as TablerHeart, Brain as TablerBrain, Eye as TablerEye, Hand as TablerHand, Foot as TablerFoot } from 'tabler-icons-react';
...
const icons = [
  ...
  { component: TablerHand, label: 'Hand', source: 'Tabler' },
  { component: TablerFoot, label: 'Foot', source: 'Tabler' },
