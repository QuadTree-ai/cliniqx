...
export default function HumanModel() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      {/* Dashboard Container */}
      <div className="relative flex flex-col items-center shadow-lg rounded-lg p-6">
        ...
        <button
          onClick={handleFlip}
          className="mt-4 px-4 py-2 bg-transparent text-white font-semibold rounded-lg hover:bg-gray-700 transition-all duration-300 flex items-center shadow-lg"
        >
          {isFrontView ? (
            <>
