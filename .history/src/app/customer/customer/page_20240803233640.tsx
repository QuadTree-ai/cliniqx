...
import InputOTPDemo from "../../signup/otp/InputOTP";
            ...
            <div className="grid gap-4">
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  className="form-checkbox h-5 w-5 text-black bg-white border-gray-300 rounded"
                />
              ...
              <Button
                type="submit"
                className="relative inline-flex items-center justify-center py-3 px-6 md:py-4 md:px-8 rounded-full bg-black text-white font-bold shadow-lg hover:bg-gradient-to-r from-gray-500 to-blue-500 transition-all duration-300"
              >
                Create an account
              </Button>
            </div>
