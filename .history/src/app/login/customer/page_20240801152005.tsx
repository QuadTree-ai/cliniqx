  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 to-gray-900">
      <div className="w-full max-w-md p-8 space-y-8">
        <h2 className="text-3xl font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-green-500 mb-2">Unify Your Healthcare Experience</h2>
        <p className="text-center text-white text-sm mb-6">
          Welcome back! Please login to continue accessing your healthcare services.
        </p>
        ...
        <form onSubmit={handleLoginClick} className="space-y-8">
          <div>
            ...
            <Input
              ...
              type="email"
              required
              className="mt-1 w-full p-3 border border-transparent bg-gray-700 text-white rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          <div>
