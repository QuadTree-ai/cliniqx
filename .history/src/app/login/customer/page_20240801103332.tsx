      ...
      <div className="flex flex-col items-center justify-center w-full lg:w-1/2 h-screen bg-gray-800 text-white p-12">
        <div className="max-w-md w-full space-y-6">
          ...
          <form className="space-y-4">
            ...
            <Button type="button" className="w-full bg-blue-500 hover:bg-blue-600 py-2 rounded text-lg">
              Login
            </Button>
          </form>
          <p className="text-center text-sm text-gray-400">
            Don’t have an account?{" "}
            <button onClick={() => console.log("Sign up clicked")} className="font-medium text-blue-300 hover:underline">
              Sign up
            </button>
          </p>
        </div>
