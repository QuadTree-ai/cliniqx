...
export default function Component() {
  ...
  return (
    <div className="w-full h-screen lg:grid lg:grid-cols-2 relative">
      ...
      <div className="flex items-center justify-center py-12 h-full bg-black">
        <div className="mx-auto w-full max-w-md p-8 bg-gray-800 rounded-lg shadow-lg text-white">
