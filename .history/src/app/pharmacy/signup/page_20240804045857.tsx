  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black min-h-screen flex flex-col">
      ...
      <div className="text-center p-10 flex-grow">
        <h1 className="text-4xl font-bold text-white text-left">Partner with CliniQX</h1>
        <p className="text-4xl mt-2 text-white text-left">at 0% commission for the 1st month!</p>
        <p className="text-white text-left">And get ads worth INR 1500. Valid for new pharmacy partners in select cities.</p>
