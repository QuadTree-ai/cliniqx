  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black min-h-screen flex flex-col items-center">
      ...
      <HeroHighlight containerClassName="w-full max-w-4xl p-10">
        ...
        <p className="text-white mb-8">And get ads worth <Highlight className="bg-gradient-to-r from-yellow-500 to-orange-500">INR 1500</Highlight>. Valid for new pharmacy partners in select cities.</p>
        <div className="flex items-start space-x-4"> {/* Changed from flex-col to flex with space-x-4 for horizontal spacing */}
          <button onClick={navigateToFormPage} className="bg-gray-700 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Register your pharmacy
          </button>
          <button onClick={navigateToLoginPage} className="bg-gray-400 hover:bg-gray-700 text-black font-bold py-2 px-4 rounded">
