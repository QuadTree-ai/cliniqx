...
import { useRouter } from 'next/navigation';  // Changed 'next/navigation' to 'next/router' for correct usage
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black min-h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl p-10">
        ...
        <p className="text-xl text-white mb-4">at 0% commission for the 1st month!</p>
        <p className="text-white mb-4">And get ads worth INR 1500. Valid for new pharmacy partners in select cities.</p>
        <div className="flex flex-col items-start">
          <button onClick={navigateToFormPage} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4">
      ...
      <div className="text-center p-10 bg-white text-gray-800 w-full max-w-4xl">
