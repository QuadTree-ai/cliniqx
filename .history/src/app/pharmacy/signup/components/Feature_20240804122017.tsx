...
const Feature: React.FC<FeatureProps> = ({ title, description, icon, index }) => {
  return (
    <div className={cn(
      ...
      (index % 2 === 0) && "border-r dark:border-neutral-800",
      ...
      <h3 className="text-lg font-bold mb-2 relative z-10 px-10">
        ...
        <span className="group-hover:translate-x-0.2 transition-transform duration-200 inline-block text-neutral-800 dark:text-neutral-100">
          {title}
        </span>
      </h3>
