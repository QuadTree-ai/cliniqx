...
const Feature: React.FC<FeatureProps> = ({ title, description, icon, index }) => {
  return (
    <div className={cn(
      ...
      "border border-neutral-200 dark:border-neutral-800" // Add border for outline
    )}>
      <div className={cn(
      ...
      <h3 className="text-lg font-bold mb-2 relative z-10 px-10">
        ...
        <span className="group-hover:translate-x-1 transition-transform duration-200 inline-block text-neutral-800 dark:text-neutral-100">
          {title}
        </span>
      </h3>
