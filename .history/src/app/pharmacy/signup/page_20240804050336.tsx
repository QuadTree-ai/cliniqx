...
const PharmacySignupPage = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black min-h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl p-10 text-left flex flex-col flex-grow items-center">
      ...
      <div className="w-full max-w-4xl text-center p-10 bg-white text-gray-800">
