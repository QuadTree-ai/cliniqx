  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-black via-gray-900 to-black px-4 py-12 sm:px-6 lg:px-8">
      ...
      <footer className="w-full py-4 bg-black text-white text-center">
        By continuing, you agree to our <a href="#" className="text-blue-500 hover:text-blue-600">Terms of Service</a>, <a href="#" className="text-blue-500 hover:text-blue-600">Privacy Policy</a>, and <a href="#" className="text-blue-500 hover:text-blue-600">Code of Conduct</a>.
      </footer>
    </div>
  );
};
