      ...
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-3/4 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-full text-white bg-gradient-to-b from-blue-500 to-blue-600 hover:bg-gradient-to-b focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200"
          >
            Log In
          </button>
          <button
            onClick={() => navigateTo('/pharmacy/signup')}
            className="w-3/4 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-full text-white bg-gradient-to-b from-green-500 to-green-600 hover:bg-gradient-to-b focus:ring-2 focus:ring-green-400 hover:shadow-xl transition duration-200"
          >
            Register
          </button>
        </div>
