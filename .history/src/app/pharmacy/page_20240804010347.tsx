        ...
        <div className="max-w-lg w-full text-center space-y-8">
          ...
          <div className="flex flex-col items-center space-y-4">
            <button
              ...
              className="shadow-[inset_0_0_0_2px_#3478f6] text-black px-12 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#3478f6] hover:text-white dark:text-neutral-200 transition duration-200"
            >
              Log In
            </button>
            <button
              onClick={() => navigateTo("/pharmacy/signup")}
              className="shadow-[inset_0_0_0_2px_#34f67a] text-black px-12 py-4 rounded-full tracking-widest uppercase font-bold bg-transparent hover:bg-[#34f67a] hover:text-white dark:text-neutral-200 transition duration-200"
            >
              Register
            </button>
          </div>
