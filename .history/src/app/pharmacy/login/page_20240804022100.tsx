      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-8 max-w-md w-full border border-gray-700">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Button
              onClick={handleLogin}
              className="w-full py-3 text-lg font-bold text-white bg-neutral-800 rounded-lg shadow-lg hover:bg-gradient-to-l focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-300"
            >
