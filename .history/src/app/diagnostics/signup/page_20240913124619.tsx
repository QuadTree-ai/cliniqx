...
import { initialSignupData, DiagnosticsSignupData, diagnosticsSignupSchema } from './diagconstants';
import Logo from "../../logos/cliniqx-invent-logo";

const DiagnosticsSignupPage: React.FC = () => {
  const router = useRouter();
  const [signupData, setSignupData] = useState<DiagnosticsSignupData>(initialSignupData);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black p-6">
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-8 max-w-4xl w-full border border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <DiagnosticsFormFields signupData={signupData} handleChange={handleChange} />
          <Button
            type="submit"
