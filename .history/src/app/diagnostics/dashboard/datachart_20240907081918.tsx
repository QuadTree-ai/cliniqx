...
import { getTestsPerMonthData } from './datafetch'
...
export const DiagnosticChart: React.FC<DiagnosticChartProps> = ({ data, title }) => {
    ...
    <>
      <div className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          <h2 className="text-lg font-semibold">Test and Patient Data</h2>
