...
export const getRecentTests = (): TestData[] => [
  { testName: 'Blood Test', date: '2023-05-15', status: 'Completed', patientName: 'John Doe', patientPhone: '123-456-7890' },
  { testName: 'X-Ray', date: '2023-05-14', status: 'Pending', patientName: 'Jane Smith', patientPhone: '234-567-8901' },
  { testName: 'MRI Scan', date: '2023-05-13', status: 'Completed', patientName: 'Bob Johnson', patientPhone: '345-678-9012' },
  { testName: 'ECG', date: '2023-05-12', status: 'Completed', patientName: 'Alice Brown', patientPhone: '456-789-0123' },
  { testName: 'Ultrasound', date: '2023-05-11', status: 'Pending', patientName: 'Charlie Davis', patientPhone: '567-890-1234' },
];
