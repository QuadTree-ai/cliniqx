...
import { Share, BarChart, FileText, Calendar, MessageCircle, CreditCard, Clipboard, Receipt } from "lucide-react";
...
const TopButtons: React.FC<TopButtonsProps> = ({ setActiveSection }) => {
  const buttons = [
    ...
    { icon: Receipt, label: "Invoices", onClick: () => setActiveSection('Invoices') },
  ];
