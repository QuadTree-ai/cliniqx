...
import { Share, BarChart, FileText, Calendar, MessageCircle, CreditCard, Clipboard, BarChart2 } from "lucide-react";
...
const TopButtons: React.FC<TopButtonsProps> = ({ setActiveSection }) => {
  const buttons = [
    ...
    { icon: BarChart2, label: "Invoices", onClick: () => setActiveSection('Invoices') },
  ];
