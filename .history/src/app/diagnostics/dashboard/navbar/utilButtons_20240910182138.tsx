...
const TopButtons: React.FC<TopButtonsProps> = ({ setActiveSection, initialActiveSection = 'analytics' }) => {
  const [activeButton, setActiveButton] = useState(initialActiveSection);

  React.useEffect(() => {
    setActiveButton(initialActiveSection);
  ...
  const handleButtonClick = (section: string) => {
    ...
    // Remove the specific case for 'tests' as it's redundant
    // The setActiveSection call above will handle all sections
  };
