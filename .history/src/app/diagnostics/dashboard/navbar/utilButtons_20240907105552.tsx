  ...
  <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-6 bg-white">
    {buttonConfig.map(({ icon: Icon, label, section }) => (
      <Button
        ...
        variant="ghost"
        className="flex-1 min-w-[100px] sm:min-w-[120px] md:min-w-[150px] h-14 sm:h-16 bg-white text-gray-700 hover:bg-gray-100 hover:text-gray-900 transition-colors duration-200 ease-in-out rounded-lg border"
      >
