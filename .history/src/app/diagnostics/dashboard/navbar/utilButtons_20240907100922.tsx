...
import { Share, BarChart2, TestTube, FileText, Calendar, MessageSquare, CreditCard, FileInvoice } from 'lucide-react';
...
const TopButtons: React.FC<TopButtonsProps> = ({ setActiveSection }) => {
  return (
    <div className="flex justify-center space-x-2 p-4">
      ...
      <Button onClick={() => setActiveSection('invoices')}><FileInvoice className="mr-2 h-4 w-4" />Invoices</Button>
    </div>
  );
};
