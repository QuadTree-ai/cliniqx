...
// Update the CustomerInfo type at the top of the file
type CustomerInfo = {
  name: string;
  image?: string;
  age: number;
...
const UploadReportCard: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (customerData) {
        const { name, image = '', age = 0, diseases = [], location = '' } = customerData;
        setCustomerInfo({ name, image, age, diseases, location });
      } else {
