...
import { CustomerInfo as CustomerInfoType, fetchCustomerInfo } from './data';
...
const UploadReportCard: React.FC = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const identifier = identifier.phone || identifier.cliniqx;
      const customerData = await fetchCustomerInfo(identifier);
      if (customerData) {
