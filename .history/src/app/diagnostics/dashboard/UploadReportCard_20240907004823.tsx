...
const UploadReportCard: React.FC = () => {
  ...
  const handleNotifyCustomer = () => {
    // Implement the logic to notify the customer
    console.log("Notifying the customer about the uploaded report");
  };
            ...
            {files.length > 0 && (
              <div className="mt-4 w-full">
                ...
                <div className="mt-6 flex space-x-4">
                  <Button onClick={handleShareReport} className="flex-1 py-2 text-base">
                    Share Report
                  </Button>
                  <Button onClick={handleNotifyCustomer} className="flex-1 py-2 text-base">
                    Notify Customer
                  </Button>
                </div>
              </div>
