...
const DiagnosticsLoginModal = () => {
  ...
  const handleEmailLogin = () => {
    router.push("/diagnostics/login/email");
  };
      ...
      <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg shadow-xl rounded-xl p-12 max-w-md w-full border border-gray-700">
        ...
        {!otpSent && (
          <p className="text-sm text-center text-white mt-8">
            ...
            <a href="/diagnostics/signup" className="underline text-blue-400 hover:text-blue-500">
              Create account
            </a>
          </p>
        )}
...
export default DiagnosticsLoginModal;
