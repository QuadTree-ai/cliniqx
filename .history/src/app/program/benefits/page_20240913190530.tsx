...
const BenefitsPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center py-16 px-6 sm:px-8 lg:px-10">
      <div className="w-full max-w-6xl space-y-16">
        <motion.h1
          className="text-4xl font-extrabold text-left text-white mb-10"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {benefits.map((benefit, index) => {
            ...
            return (
              <motion.div
                key={index}
                className="flex flex-col items-start space-y-6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-gray-700 p-8 rounded-lg"
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <div className="text-left">
          <Button className="mt-16 py-3 px-6 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">
            Join CliniQX Now
          </Button>
        </div>
      </div>
