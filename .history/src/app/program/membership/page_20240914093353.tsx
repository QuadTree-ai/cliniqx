...
const PlanCard = ({ plan }) => {
  ...
  return (
    <Card className="w-full bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg border border-gray-700 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col justify-between">
      <div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-6xl space-y-12">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">User Plans</h2>
        ...
        <div>
          <h2 className="text-2xl font-bold text-white mb-4">Enterprise Plans</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
