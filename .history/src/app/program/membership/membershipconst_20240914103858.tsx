...
import { CheckCircle, Shield, Heart, User, Users, Briefcase, Star, Calendar, Tag, Phone, Activity, Award, MapPin, Clock, Zap, Database, Lock, Headphones, FileText, Layers, Package, CreditCard, Truck, BarChart, Building, BarChart2, Globe } from "lucide-react";
...
export const enterprisePlans: Plan[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      { icon: BarChart2, title: "Advanced analytics and insights" },
