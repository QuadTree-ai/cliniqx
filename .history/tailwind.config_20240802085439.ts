import type { Config, PluginFunction } from "tailwindcss";
import svgToDataUri from "mini-svg-data-uri";

// Defining the plugin using the proper PluginFunction type
const gridPatternPlugin: PluginFunction = ({ addUtilities }) => {
